...
import { TrendingDown, TrendingUp, DollarSign, Clock, Users, Zap, Shield, BarChart3 } from "lucide-react";
...
const AnalyticsDashboard = ({ allocations, isVisible, llmResponse }: AnalyticsDashboardProps) => {
  ...
  const avgRate = allocations.length > 0 
    ? allocations.reduce((sum, a) => sum + a.employee.hourlyRate, 0) / allocations.length 
    : 0;
